...
const short SCREEN_ROWS     = 25;
const short SCREEN_COLUMNS  = 80;
const short LEVEL_ROWS      = SCREEN_ROWS;
const short LEVEL_COLUMNS   = 70;
...
////////////////////////////////////
// Информация о базе
const float BASE_COLUMNS = 8.0f;
const float BASE_ROWS = 2.0f;
const short BASE_HEALTH = 10;

const sf::IntRect BASE_IMAGE = sf::IntRect(0, 0, 256, 64);
